...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder>  {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Adapta os dados da partidas (recuperadas da API) para o nosso layout
        Glide.with(context)
        ...
        if (match.getHomeTeam().getScore() != null)
            holder.binding.tvHomeTeamScore.setText(
                    String.valueOf(match.getHomeTeam().getScore())
            );
        ...
        if (match.getAwayTeam().getScore() != null)
            holder.binding.tvAwayTeamScore.setText(
                    String.valueOf(match.getAwayTeam().getScore())
            );
    }
